...
Considérons l'oscillateur entretenu de Van der Pol:
\[(VDP)
\left\{
\begin{array}{ll}
...
\centering
\begin{tabular}{ccl}
\subfloat[Solutions $y_1$ et $y_2$, avec \texttt{ode45()}.]{\includegraphics[scale=0.7]{ex4_ultimate3.png}}
&
\subfloat[Portrait de phases.]{\includegraphics[scale=0.7]{ex4_ultimate.png}}
\\
\end{tabular}
