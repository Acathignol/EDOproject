...
\begin{center}
\begin{figure}[b!]
\includegraphics[height=3.2cm]{/run/media/acathignol/E822-B546/EDO/InsaBioLogo3.png}
\end{figure}
\end{center}
\newpage
...
Donc on a deux équilibres, en ${y_1 \choose y_2}={0 \choose 0}$ et ${2 \choose  8/3}$.Pour étudier leur stabilité, on linéarise le système au voisinage des points par un développement de Taylor d'ordre 1:\\
Soit $
A=
\left(
\begin{array}{cc}
